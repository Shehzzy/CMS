...
<header class="header-area">
    ...
    <div style="background-color:peru; width: 1000px; margin-left: 400px; margin-top:100px; border-radius: 20px;" >
        <br>
        <h1><u><center>Al Khidmat Hospital</center></u></h1>
    
<br>
<br>
<div style="margin-left:30px;">
     <h2>Contact Number: 0330-7654298</h2>
     <br>
     <h2>Location: Gulshan E Iqbal Block 8</h2>
     <br>
     <h2>Consultants: Dr Rida , Dr Hamza , Dr Asim, Dr Haiqa</h2>
     <br>
     <h2>Covid Vaccine: Sinovac</h2>
     <br>
